...
LOCAL_MODULE           := libSCjpeg_interface
LOCAL_SHARED_LIBRARIES := libdl libcutils liblog libSCmx_core libSCcamera_interface
ifeq ($(strip $(LIB2D_ROTATION)),true)
    LOCAL_SHARED_LIBRARIES += libSClib2d_interface
endif
